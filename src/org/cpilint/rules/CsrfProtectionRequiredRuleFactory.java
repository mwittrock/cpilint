...
public final class CsrfProtectionRequiredRuleFactory implements RuleFactory {

	@Override
	public boolean isFactoryFor(String ruleElementName) {
		return ruleElementName.equals("csrf-protection-required");
	}
	...
	public Rule createFrom(Element e) {
		...
		return new CsrfProtectionRequiredRule();
	}
