...
public final class ReceiverAdaptersRuleFactory extends AllowDisallowRuleFactoryBase<ReceiverAdapter, ReceiverAdaptersRule> {
	...
	static {
		...
		receiverAdapters.put("amazondynamodb", ReceiverAdapter.AMAZONDYNAMODB);
		receiverAdapters.put("amazoneventbridge", ReceiverAdapter.AMAZONEVENTBRIDGE);
		receiverAdapters.put("amqp", ReceiverAdapter.AMQP);
		receiverAdapters.put("anaplan", ReceiverAdapter.ANAPLAN);
		...
		receiverAdapters.put("smb", ReceiverAdapter.SMB);
